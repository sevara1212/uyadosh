...
async function initializeData() {
  try {
    ...
    console.log('- Users collection with sample user profiles');
    console.log('- Rooms collection with sample activity rooms');
    console.log('- Proper indexes for querying rooms by sport type and participants');
  } catch (error) {
