...
const testMainPage = async () => {
  try {
    console.log('🎯 Testing main page with recommendation system...');
    ...
    console.log('🏆 Top 7 recommended activities for main page:');
    ...
    if (scoredActivities.length > 0) {
      console.log('🎉 SUCCESS! Main page should now display recommended activities!');
      console.log('📱 The main page will show 7 recommended activities based on:');
      console.log('   • User interests (if logged in)');
      console.log('   • Available spots (not full activities)');
      console.log('   • Activities happening soon');
      console.log('   • Social factor (more participants)');
    } else {
      console.log('⚠️  No upcoming activities found for recommendations.');
    }
